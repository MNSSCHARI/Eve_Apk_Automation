...
public class BaseTest {
    ...
    public  Eeki_dev_Testing_Page  eekiDevTestingPage;
    ...
    public void ConfigureAppium() throws MalformedURLException {
        ...
        service = new AppiumServiceBuilder()
                .withAppiumJS(new File("C://Users//91918//AppData//Roaming//npm//node_modules//appium//build//lib//main.js"))
                .withIPAddress("127.0.0.1").usingPort(4723).build();
        service.start();

        // Set up Appium capabilities
        UiAutomator2Options options = new UiAutomator2Options();
        options.setDeviceName("Moto Edge 50 Pro"); // Device name for testing
        options.setApp("C://Users//91918//Downloads//app-dev-release.apk"); // Path to your APK
